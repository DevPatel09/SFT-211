...
namespace UnitTest1
{
	...
	public:
		...
		//BLACK BOX TESTING
		//This is the PASSED test, because the input is DEV which is a string.
		...
		{
			char input[] = "sssssssssssssssssssssssssssssssssssssssssssssssssss";
	...
	public:
		...
		{
			size_t length = 11;
			char pos[] = "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD";
